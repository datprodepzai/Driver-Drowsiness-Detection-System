...
import numpy as np
from tensorflow.keras.preprocessing.image import ImageDataGenerator  # Thay đổi ở đây
from tensorflow.keras.utils import to_categorical  # Thay đổi ở đây
import random
import shutil
from tensorflow.keras.models import Sequential  # Thay đổi ở đây
from tensorflow.keras.layers import Dropout, Conv2D, Flatten, Dense, MaxPooling2D  # Thay đổi ở đây
from tensorflow.keras.models import load_model  # Thay đổi ở đây
